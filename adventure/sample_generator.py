...
class World:
    ...
    def generate_rooms(self, size_x, size_y, num_rooms):
        ...
        kittyRooms = ["Den", "Livingroom", "Garage", "Pantry", "Sewing room", "Hallway",
                    "Kitchen", "Bedroom", "Laundry room", "Entertainment room", "Bathroom","Patio", "Dining room"]
        ...
        while room_count < num_rooms:
            ...
            # Moving along the x/y axis.  North and south are dependent upon the random integer sent to the newDirection.
            # For instance, in the first if statement, if the number is greater than 7 and the other conditions apply, it'll go South.
